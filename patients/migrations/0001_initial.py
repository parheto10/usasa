    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pays', models.CharField(choices=[('CAM', 'CAMEROUN'), ('CIV', "COTE D'IVOIRE")], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symptome_nourrisson', models.ManyToManyField(blank=True, to='parametres.Nourrison')),
            ],
            options={
                'verbose_name': 'rdv',
